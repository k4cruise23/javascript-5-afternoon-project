...
// Code here
Movie.prototype.changeRating = function(newRating, oldRating){
...
//   for(let i = 0; i < this.savedPosts.length; i++){
//     if(id === this.savedPosts[i].id){
//       this.savedPosts.splice(i, 1, newRating)
//     }
//   }
// }
...
User.prototype.savedPosts = function(id, title, rating){
  this.savedPosts.push({id, title, rating})
}
